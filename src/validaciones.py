...
def validar_edad(entrada: str) -> int:
    ...
    try:
        ...
        if 14 <= edad <= 99:
            ...
            print("  ⚠️  Edad fuera de rango. Se omitirá este dato.")
            return 0
    except ValueError:
        print("  ⚠️  Entrada inválida para edad. Se omitirá este dato.")
        return 0
...
def validar_genero(entrada: str) -> str:
    ...
    print("  ⚠️  Opción no reconocida. Se registrará como 'No especificado'.")
    ...
    while True:
        try:
            ...
            if 1 <= valor <= 5:
                ...
                print("  ⚠️  Por favor ingresá un número entre 1 y 5.")
        except ValueError:
            print("  ⚠️  Entrada inválida. Ingresá solo un número del 1 al 5.")
